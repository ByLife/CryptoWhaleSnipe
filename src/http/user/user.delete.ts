...
export default {
    ...
    run: async (req: express.Request, res: express.Response) => {
        try {
            ...
            if(!req.body.username) throw "Missing parameters in request body for deleting a user, missing 'username'"
            if(typeof req.body.username !== "string") throw "Invalid parameters in request body for deleting a user, username is not a string"
