    ...
    run: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            if (!req.body.username)
                throw "Missing parameters in request body for deleting a user, missing 'username'";
            if (typeof req.body.username !== "string")
                throw "Invalid parameters in request body for deleting a user, username is not a string";
